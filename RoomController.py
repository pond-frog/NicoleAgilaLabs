...
class RoomController:
    ...
    def __init__(self):
        ...
        self._partylight = NeoPixel(pin=17, numleds=10, brightness=1)
        self._sensor = DigitalSensor(28)
        self._partymusic = PassiveBuzzer(pin=19)
...
#still missing sensor transition do it in state do because its an if statement
    ...
    def stateDo(self, state):
        ...
        if state == 0:
            ...
            # do actions for state 2    
            self._partymusic.beep(tone=262)
            self._partymusic.beep(tone=262)
            self._partymusic.beep(tone=294)
            self._partymusic.beep(tone=262)
            self._partymusic.beep(tone=262)
            self._partymusic.beep(tone=294)
            self._partymusic.beep(tone=294)
            self._partymusic.beep(tone=330)
            self._partymusic.beep(tone=262)
            self._partymusic.beep(tone=330)
            self._partymusic.beep(tone=330)
            self._partymusic.beep(tone=349)
            self._partymusic.beep(tone=349)
            self._partymusic.beep(tone=392)
            self._partymusic.beep(tone=392)
            self._partymusic.beep(tone=392)
            self._partymusic.beep(tone=330)
            self._partymusic.beep(tone=330)
            ...
            self._partymusic.beep(tone=349)
            self._partymusic.beep(tone=262)
            self._partymusic.beep(tone=440)
            self._partymusic.beep(tone=392)
            self._partymusic.beep(tone=349)
            self._partymusic.beep(tone=349)
            self._partymusic.beep(tone=330)
