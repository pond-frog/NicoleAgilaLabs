...
class StopwatchController:
    ...
    def __init__(self):
        ...
        # do the handling
        self._button1 = Button(18, "start", buttonhandler=None)
        self._button2 = Button(16, "stop", buttonhandler=None)
        self._button3 = Button(19, "lap", buttonhandler=None)
        ...
        self._model.addTransition(1, [BTN3_PRESS], 2)
        self._model.addTransition(2, [BTN3_PRESS], 1)
    ...
    def stateDo(self, state):
        ...
        if state == 1: #prints timkeeper in the row I want
            self._display.showText(str(self._timekeeper), row=2)

        elif state == 2: #prints current lap and time stamp. I cannot get it to add sevral laps
            self._display.showText((f"Lap{self._lap.current()} {self._timekeeper}"), row=1, col=0)
        
        elif state == 0:
            # entry actions for state 0
            print('State 0 entered')
            self._display.showText('Ready, Set, Go!')
